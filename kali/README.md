# Kali Unattended ISO Builder

Automated hybrid ISO generator for unattended Kali installations, using WSL.
...
```bash
# Running with no flags defaults to Kali 100% unattended
sudo ./kali_iso_builder.sh

# Kali with interactive disk selection
sudo ./kali_iso_builder.sh --node 155 --interactive
